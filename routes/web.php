...
Route::get('products/pay/return', 'ProductController@payReturn')->name('products.pay.return');
Route::post('products/pay/notify', 'ProductController@payNotify')->name('products.pay.notify');

Route::middleware(['setLocale'])->group(function () {
    Route::get('users/forbidden', 'UserController@forbidden')->name('_users.forbidden');
    Route::get('users/expiry', 'UserController@expiry')->name('_users.expiry');
    Route::middleware(['serviceExpiry'])->group(function () {
